...
- **Search with Bangs**: Added support for over 13,500 DuckDuckGo bang operators! Use `!w` for Wikipedia, `!yt` for YouTube, and thousands more directly from the Omnibar. Typing a bang without a query (e.g. `!w`) now takes you directly to the site's homepage.
