 ...
 * This is designed to be wrapped by TabContextMenu for context menu functionality.
 * Uses forwardRef to allow ContextMenuTrigger to attach event handlers when using asChild.
 */
