...
export const Kbd = ({ className, ...props }: KbdProps) => {
  return (
    <kbd
      ...
      className={cn(
        `
          pointer-events-none inline-flex h-5 w-fit min-w-5 select-none
          items-center justify-center gap-1 whitespace-nowrap rounded-sm border
          border-border bg-input px-1 font-mono text-xs font-medium leading-none
          text-muted
