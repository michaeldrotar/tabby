...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-accent/[calc(var(--accent-strength)*1%)] data-[highlighted]:text-foreground data-[disabled]:opacity-50',
      inset && 'pl-8',
      className,
    )}
    {...props}
